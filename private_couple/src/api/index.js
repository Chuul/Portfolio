...
function patchUrl(payload) {
	return axios.patch(`${config.baseUrl}item/url/${payload.id}`, {
		data: { urlText: payload.textArea },
	});
}
function patchPos(payload) {
	return axios.patch(`${config.baseUrl}item/pos/${payload.id}`, {
...
function patchComment(payload) {
	return axios.patch(`${config.baseUrl}start/comment/${payload.id}`, {
		data: { comment: payload.comment },
	});
}
function toggleFalseItem(id) {
	return axios.patch(`${config.baseUrl}start/false/${id}`, {
		data: { checked: false },
	});
}
...
function patchStartUrl(payload) {
	return axios.patch(`${config.baseUrl}start/url/${payload.id}`, {
		data: { urlText: payload.textArea },
	});
}
function patchStartPos(payload) {
	return axios.patch(`${config.baseUrl}start/pos/${payload.id}`, {
		data: { posText: payload.textArea },
	});
}
// last
